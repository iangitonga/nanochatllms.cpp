...
{
    // prompt format: '<用户>' + prompt.strip() + '<AI>'
    prompt = "<用户>" + prompt + "<AI>";

    // Note: out tokens must start with <bos> token.
...
// {
//     std::cout << "open\n";
//     Tokenizer tokenizer{"tokenizer.bin", 122753};
...
//     {
//         std::cout << tokenizer.decode(tokens[i-1], tokens[i]);
//     } std::cout << "\n";
